...
<div align="center" style="padding:5px">
	<form method="post">
		<input type="hidden" name="deptId" value="${sessionInfo.deptId}" /> <input type="hidden" name="userId" value="${sessionInfo.userId}" />
		<table  class="input_table">
			<tr >
				<th>归属办法：</th>
				<td colspan="3"><input type="text" id="budget_file_input" name="fileId" style="width:440px" />
				</td>
			</tr>
			<tr>
				<th width="120">归属专业：</th>
