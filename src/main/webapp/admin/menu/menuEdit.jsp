	...
	<form method="post">
		...
		<table width="500" class="input_table">
			...
			<tr>
				...
				<th>上级菜单：</th>
				<td><input id="menuEdit_pid" name="pid" /><span onclick="$('#menuEdit_pid').combotree('clear');" class="icon-clear" style="cursor: pointer;display:inline-block;vertical-align:middle;width:16px;height:16px;"></span></td>
			</tr>
		</table>
	</form>
</div>